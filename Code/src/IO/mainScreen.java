...
//        serverPort = Integer.parseInt(getParameter("port"));
 ...
 public void displayQuestion(int index)
 {
    ...
    public void actionPerformed(ActionEvent actionEvent) // action listner class
    {
        ...
        if(actionEvent.getSource() == btnSend) { linkedList.head.append(new Node( " <-->  " + questionBox.getText()+ "--" + topicBox.getText() + "--" + subtopicBox.getText())); LinkedList.setText(linkedList.toString());
